...
class SettingsDialog(QDialog):
    ...
    def create_general_tab(self) -> QWidget:
        ...
        template_help = QLabel("Değişkenler: $saat, $tarih, $havadurumu, $sehir, $sicaklik")
        ...
        self.announce_template_input.setPlaceholderText("Örn: Saat $saat. $sehir hava durumu: $havadurumu.")
        self.announce_template_input.setMaximumHeight(80) # Çok yer kaplamasın
        ...
        # reset_template_btn.setFixedSize(120, 25) # Esnek olsun
