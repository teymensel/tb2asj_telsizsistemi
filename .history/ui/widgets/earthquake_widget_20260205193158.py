...
class EarthquakeWidget(QWidget):
    ...
    def init_ui(self):
        ...
        header.setSectionResizeMode(0, QHeaderView.ResizeMode.ResizeToContents) # Saat
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents) # Mag
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.Stretch)          # Konum
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents) # Derinlik
