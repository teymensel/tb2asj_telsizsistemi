...
class SettingsDialog(QDialog):
    ...
    def create_general_tab(self) -> QWidget:
        ...
        template_help.setStyleSheet("font-size: 10px; color: gray;")
        template_layout.addWidget(template_help)
        
        self.announce_template_input = QLineEdit()
        self.announce_template_input.setPlaceholderText("Saat $saat. $sehir hava durumu: $havadurumu.")
        template_layout.addWidget(self.announce_template_input)
        
        # Varsayılana dön butonu
        reset_template_btn = QPushButton("Varsayılan Şablon")
        reset_template_btn.clicked.connect(self.reset_template)
        reset_template_btn.setFixedSize(120, 25)
        template_layout.addWidget(reset_template_btn)
