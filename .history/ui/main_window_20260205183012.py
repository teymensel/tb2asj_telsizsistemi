...
class MainWindow(QMainWindow):
    ...
    def connect_signals(self):
        ...
        self.vox_control.test_requested.connect(self.send_test_notification)
    ...
    def connect_radio(self):
        ...
        if not port:
            QMessageBox.warning(
                self,
                "Uyarı",
                "COM port ayarlanmamış. Lütfen ayarlar menüsünden port seçiniz."
            )
            self.open_settings()
            return
    ...
    def on_radio_connected(self):
        ...
        self.signal_meter.set_status("Bağlı", "connected")
        
        if self.tray_icon:
            self.tray_icon.showMessage(
                "TB2ASJ",
                "Telsiz bağlantısı kuruldu",
    ...
    def on_vox_triggered(self):
        ...
        self.signal_meter.set_status("İletim", "connected")
    ...
    def on_error(self, error_msg: str):
        ...
        if settings.get('general.show_errors', True):
    ...
    def show_about(self):
        ...
        QMessageBox.about(
            ...
            "<p><b>Özellikler:</b></p>"
            "<ul>"
            "<li>COM Port ve AUX bağlantı desteği</li>"
            "<li>VOX (ses tetiklemeli PTT) kontrolü</li>"
            "<li>Otomatik hava durumu bildirimleri</li>"
            "<li>Anlık deprem uyarıları</li>"
